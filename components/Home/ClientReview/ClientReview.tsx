...
const ClientReview = () => {
    return (
        <div className='pt-16 pb-16 bg-gray-100'>
            {/* Heading */}
            <h1 className='capitalize text-center text-2xl text-blue-950 font-bold'>what our client says</h1>
            {/* Sub heading */}
            ...
            <div
                ...
                className='grid grid-cols-1 lg:grid-cols-2 gap-4 items-center mt-16 w-[80%] mx-auto'>
