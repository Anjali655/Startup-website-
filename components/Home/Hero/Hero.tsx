    ...
    return (
        <div className="relative w-full h-[110vh] sm:h-screen bg-[url('/images/bg.png')] bg-cover bg-center flex justify-center flex-col">
            <div className='w-[90%] md:w-[80%] mx-auto items-center grid grid-cols-1 xl:grid-cols-2 gap-10'>
                {/* Text content*/}
                <div data-aos="fade-up" className='sm:justify-center sm:items-center sm:mx-auto'>
                    <p className='text-sm sm:text-base md:text-xl font-bold text-blue-950'>Make the Smartest Investment</p>
                    <h1 className='text-2xl md:text-3xl lg:text-4xl mt-6 mb-6 font-bold text-blue-950 leading-[2.5rem] md:[leading-3.5rem]'>
                        Kickstart, Scale and Thrive Faster with <span className='text-rose-700'>TechDev</span>
                    </h1>
                    <p className='text-xs sm:text-sm md:text-base font-medium text-gray-700'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Quo incidunt numquam, temporibus corporis est harum natus optio laboriosam tenetur obcaecati!
                    </p>
                    {/* Ratings*/}
                    <div className='flex mt-6 sm:flex-row flex-col sm:items-center sm:space-x-10'>
                        {/* Google ratings*/}
                    ...
                    <div className='mt-8 flex flex-col sm:flex-row w-fit sm:items-center space-y-4 sm:space-y-0 sm:space-x-4'>
                        ...
                        <a href="#_" className="relative px-10 py-3 font-medium text-white transition duration-300 bg-rose-600 rounded-md hover:bg-rose-800 ease">
